...
var StudentsController = function () {
    var _classDecorators = [(0, common_1.Controller)("students")];
    ...
    var StudentsController = _classThis = /** @class */ (function () {
        function StudentsController_1(svc) {
            this.svc = (__runInitializers(this, _instanceExtraInitializers), svc);
        }
        StudentsController_1.prototype.list = function () {
            return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
                return [2 /*return*/, this.svc.list()];
            }); });
        };
        StudentsController_1.prototype.one = function (id) {
            return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
                return [2 /*return*/, this.svc.one(id)];
            }); });
        };
